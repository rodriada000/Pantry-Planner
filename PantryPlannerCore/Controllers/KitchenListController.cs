...
namespace PantryPlanner.Controllers
{
    ...
    public class KitchenListController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<KitchenListDto>> AddNewKitchenList(KitchenListDto newList)
        {
            PantryPlannerUser user = null;
            ...
            var dto = new KitchenList()
            {
                KitchenId = newList.KitchenId,
                Name = newList.Name
            };
            ...
            try
            {
                ...
                await _service.AddKitchenListAsync(dto, user);
            }
            catch (ArgumentNullException e)
            {
                return BadRequest(e.Message);
            ...
            return StatusCode(StatusCodes.Status201Created, new KitchenListDto(dto));
        }
