...
namespace PantryPlanner.Services
{
    public class RecipeIngredientService : IPantryService
    {
        ...
        {
            return Context.RecipeIngredients.Where(r => r.RecipeIngredientId == recipeIngredientId)
                                            .Include(i => i.Recipe)
        ...
        public List<RecipeIngredient> GetIngredientsForRecipe(long recipeId, PantryPlannerUser user)
        {
            ...
            return Context.RecipeIngredients.Where(r => r.RecipeId == recipeId)
        ...
        public RecipeIngredient AddRecipeIngredient(RecipeIngredient newRecipeIngredient, PantryPlannerUser user)
        {
            ...
            newRecipeIngredient.Ingredient = Context.Ingredients.Where(r => r.IngredientId == newRecipeIngredient.IngredientId).FirstOrDefault();
        ...
        private int GetNextSortOrderForRecipe(long recipeId)
        {
            ...
            if (Context.RecipeIngredients.Any(r => r.RecipeId == recipeId) == false)
            {
                return 1;
            }

            int maxSortOrder = Context.RecipeIngredients.Where(r => r.RecipeId == recipeId)
        ...
        public RecipeIngredient DeleteRecipeIngredient(long recipeIngredientId, PantryPlannerUser userDeleting)
        {
            ...
            RecipeIngredient ingredientToDelete = Context.RecipeIngredients.Where(r => r.RecipeIngredientId == recipeIngredientId).FirstOrDefault();
